...
<head>
    ...
    <style type="text/css">
        ...
        .other_info_table .info_detail b {
            font-weight: normal;
            color: #1cfe16;
        }

        .other_info_table .info_detail span {
            color: #FFCC00;
        }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if ((based_modelid == "RT-N18U") || (based_modelid == "RT-AC56U") ||
                        ...
                        (based_modelid == "RT-AC5300") || (based_modelid == "RT-AC3100") || (based_modelid == "EA6200") || (based_modelid == "EA6400") || (based_modelid == "EA6700") || (based_modelid == "EA6900") || (based_modelid == "EA9200") || (based_modelid == "R7000") || (based_modelid == "R6300V2") || (based_modelid == "R6400")) {
...
<body class="statusbody" onload="initial();">
    ...
    <form method="post" name="form" id="form" action="/start_apply2.htm">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="padding-left:5px">
            <tr>
                <td>
                    <table width="100px" border="0" align="left" style="margin-left:8px;" cellpadding="0"
                        cellspacing="0">
                        <td>
                            <div id="t0" class="tab_NW" align="center"
                                style="font-weight: bolder;display:none; margin-right:2px; width:90px;"
                                onclick="tabclickhandler(0)">
                                <span id="span0" style="cursor:pointer;font-weight: bolder;">2.4GHz</span>
                            </div>
                        </td>
                        <td>
                            <div id="t1" class="tab_NW" align="center"
                                style="font-weight: bolder;display:none; margin-right:2px; width:90px;"
                        ...
                        <td>
                            <div id="t2" class="tab_NW" align="center"
                                style="font-weight: bolder;display:none; margin-right:2px; width:90px;"
                        ...
                        <td>
                            <div id="t3" class="tabclick_NW" align="center"
                                style="font-weight: bolder; margin-right:2px; width:90px;" onclick="tabclickhandler(3)">
                                ...
                                <td colspan="3">
                                    <div style="margin:0px 11px 0px 11px;background-color:black;">
                                        <svg width="270px" height="100px">
                                            <g>
                                                <line stroke-width="1" stroke-opacity="1" stroke="rgb(255,255,255)"
                                                    x1="0" y1="0%" x2="100%" y2="0%" />
                                                <line stroke-width="1" stroke-opacity="0.2" stroke="rgb(255,255,255)"
                                            ...
                                            <g>
                                                <text font-family="Verdana" fill="#FFFFFF" font-size="8" x="0"
                                                    y="98%">0%</text>
                                                <text font-family="Verdana" fill="#FFFFFF" font-size="8" x="0"
                                                    y="55%">50%</text>
                                                <text font-family="Verdana" fill="#FFFFFF" font-size="8" x="0"
                                            ...
                                            <line stroke-width="1" stroke-opacity="1" stroke="rgb(0,0,121)" x1="0"
                                                y1="0%" x2="0" y2="100%" id="tick1" />
                                            <line stroke-width="1" stroke-opacity="0.3" stroke="rgb(40,255,40)" x1="30"
                                                y1="0%" x2="30" y2="100%" id="tick2" />
                                            <line stroke-width="1" stroke-opacity="0.3" stroke="rgb(40,255,40)" x1="60"
                                                y1="0%" x2="60" y2="100%" id="tick3" />
                                            <line stroke-width="1" stroke-opacity="0.3" stroke="rgb(40,255,40)" x1="90"
                                                y1="0%" x2="90" y2="100%" id="tick4" />
                                            <line stroke-width="1" stroke-opacity="0.3" stroke="rgb(40,255,40)" x1="120"
                                                y1="0%" x2="120" y2="100%" id="tick5" />
                                            <line stroke-width="1" stroke-opacity="0.3" stroke="rgb(40,255,40)" x1="150"
                                                y1="0%" x2="150" y2="100%" id="tick6" />
                                            <line stroke-width="1" stroke-opacity="0.3" stroke="rgb(40,255,40)" x1="180"
                                                y1="0%" x2="180" y2="100%" id="tick7" />
                                            <line stroke-width="1" stroke-opacity="0.3" stroke="rgb(40,255,40)" x1="210"
                                                y1="0%" x2="210" y2="100%" id="tick8" />
                                            <line stroke-width="1" stroke-opacity="0.3" stroke="rgb(40,255,40)" x1="240"
                                                y1="0%" x2="240" y2="100%" id="tick9" />
                                            <line stroke-width="1" stroke-opacity="1" stroke="rgb(0,0,121)" x1="270"
                                                y1="0%" x2="270" y2="100%" id="tick10" />
                                            <polyline id="cpu0_graph"
                                                style="fill:none;stroke:#FF9000;stroke-width:1;width:200px;" points="">
                                            </polyline>
                                            <polyline id="cpu1_graph"
                                                style="fill:none;stroke:#3CF;stroke-width:1;width:200px;display:none;"
                                                points=""></polyline>
                                            <polyline id="cpu2_graph"
                                                style="fill:none;stroke:#FC0;stroke-width:1;width:200px;display:none;"
                                                points=""></polyline>
                                            <polyline id="cpu3_graph"
                                                style="fill:none;stroke:#FF44FF;stroke-width:1;width:200px;display:none;"
                                                points=""></polyline>
                                        </svg>
                                    </div>
                                </td>
                                ...
                                <td colspan="3">
                                    <div style="margin:0px 11px 0px 11px;background-color:black;">
                                        <svg width="270px" height="100px">
                                            ...
                                            <line stroke-width="1" stroke-opacity="1" stroke="rgb(0,0,121)" x1="270"
                                                y1="0%" x2="270" y2="100%" id="tick10" />
                                            <polyline id="ram_graph"
                                                style="fill:none;stroke:#0096FF;stroke-width:1;width:200px;" points="">
                                        </svg>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td colspan="2">
                                    <div style="margin:0px 11px 0px 11px;background-color:black;">
                                        <svg width="270px" height="100px">
                                            ...
                                            <g>
                                                <text font-family="Verdana" fill="#FFFFFF" font-size="8" x="0" y="99%">0
                                                    KB/s</text>
                                                <text font-family="Verdana" fill="#FFFFFF" font-size="8" x="0" y="55%"
                                                    id="speed_half">25 KB/s</text>
                                                <text font-family="Verdana" fill="#FFFFFF" font-size="8" x="0" y="10%"
                                                    id="speed_max">50 KB/s</text>
                                            </g>
                                            <line stroke-width="1" stroke-opacity="1" stroke="rgb(0,0,121)" x1="0"
                                                y1="0%" x2="0" y2="100%" id="tick1" />
                                            <line stroke-width="1" stroke-opacity="0.3" stroke="rgb(40,255,40)" x1="30"
                                            ...
                                            <line stroke-width="1" stroke-opacity="1" stroke="rgb(0,0,121)" x1="270"
                                                y1="0%" x2="270" y2="100%" id="tick10" />
                                            <polyline id="download_graph"
                                                style="fill:#FF9000;stroke:#FF9000;stroke-width:1;width:200px;fill-opacity: 0.5"
                                                points=""></polyline>
                                            <polyline id="upload_graph"
                                                style="fill:#3CF;stroke:#3CF;stroke-width:1;width:200px;fill-opacity:0.5;"
                                                points=""></polyline>
                                        </svg>
                                    </div>
                                </td>
                        ...
                        <table width="98%" border="1" align="center" cellpadding="4" cellspacing="0" class="table1px">
                            ...
                            <tr class="other_info_table">
                                <td>
                                    ...
                                    <div class="info_detail"><span id="boot_days"></span> 天 <span
                                            id="boot_hours"></span> 时 <span id="boot_minutes"></span> 分 <span
                                            id="boot_seconds"></span> 秒</div>
                                </td>
                            </tr>
                            <tr class="other_info_table">
                                <td>
